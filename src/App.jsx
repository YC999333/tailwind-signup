...
function App() {
  return (
    <div className="App flex flex-col font-poppins sm:flex-row justify-center md:gap-10 sm:p-5 sm:p-1 items-center bg-bgImage bg-bgred min-h-screen py-20">
      <div className="w-4/5 sm:w-1/2 md:w-1/3 xl:1/4 p-2 mt-10">
